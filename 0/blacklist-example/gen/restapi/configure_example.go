...
//go:generate swagger generate server --target ../../gen --name Example --spec ../../swagger/swagger.yml --principal models.Principal --exclude-main
...
func configureAPI(api *operations.ExampleAPI) http.Handler {
	...
	api.IsAuthenticatedAuth = func(token string) (*models.Principal, error) {
